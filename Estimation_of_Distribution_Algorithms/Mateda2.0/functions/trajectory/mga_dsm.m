...
%Usage:     [J,DVvec,dsm_epoch,flyby_epoch] = mga_dsm(t,MGADSMproblem)
%Outputs:
...
%           dsm_epoch: vector of epochs (mjd2000) corresponding to each DV maneuver
%           flyby_epoch: vector of epochs (mjd2000) corresponding to each flyby
%
%
%Inputs:
%           t:         decision vector
...
yplot = problem.yplot; 			%This option is deactivated in this version of the mga_dsm.m
...
%KM=AU; % Roberto, global variable AU was not initialized
