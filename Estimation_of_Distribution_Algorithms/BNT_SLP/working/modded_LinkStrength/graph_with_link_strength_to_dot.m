function graph_with_link_strength_to_dot (bnet, filename, formula, is_percentage, varargin )
...
% By Imme Ebert-Uphoff (2006)
   ...
   AUX_graph_main ( bnet, filename, 'LS', use_node_names, ...
			    shape1, shape2, is_percentage, formula, 0);
